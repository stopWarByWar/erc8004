...
func NewIndexer(identityAddr, reputationAddr, validationAddr, commentAddr, rpcURL string, fetchBlockInterval int64, _logger *logger.Logger) *Indexer {
...
func (idx *Indexer) process(currentBlockNum int64) {
...
func (idx *Indexer) dealWithEvent(e types.Log) error {
	switch e.Topics[0] {
...
func (idx *Indexer) dealWithAgentRegisteredEvent(e types.Log) error {
