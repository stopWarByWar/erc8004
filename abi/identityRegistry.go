...
//
// Solidity: function getAgentWallet(uint256 agentId) view returns(bytes)
func (_IdentityRegistry *IdentityRegistryCaller) GetAgentWallet(opts *bind.CallOpts, agentId *big.Int) ([]byte, error) {
	var out []interface{}
...
//
// Solidity: function getAgentWallet(uint256 agentId) view returns(bytes)
func (_IdentityRegistry *IdentityRegistrySession) GetAgentWallet(agentId *big.Int) ([]byte, error) {
...
//
// Solidity: function getAgentWallet(uint256 agentId) view returns(bytes)
func (_IdentityRegistry *IdentityRegistryCallerSession) GetAgentWallet(agentId *big.Int) ([]byte, error) {
	return _IdentityRegistry.Contract.GetAgentWallet(&_IdentityRegistry.CallOpts, agentId)
}
